...
// {
// public:
//   explicit BatteryState(const std::string & name) : SemanticComponentInterface(name, 10)
//   {
//     interface_names_.emplace_back(name_ + "/" + "voltage");
//     interface_names_.emplace_back(name_ + "/" + "temperature");
...
//     interface_names_.emplace_back(name_ + "/" + "design_capacity");
